...
--
-- Host: 127.0.0.1:3307
-- Generation Time: Jun 05, 2022 at 06:44 PM
...
--
ALTER TABLE `tbl_role`
  MODIFY `roleID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25257672;

--
-- AUTO_INCREMENT for table `tbl_user`
--
ALTER TABLE `tbl_user`
  MODIFY `userID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=84575460;
...
--
ALTER TABLE `tbl_invoice`
  ADD CONSTRAINT `tbl_invoice_ibfk_1` FOREIGN KEY (`methodID`) REFERENCES `tbl_payment_methods` (`methodID`),
  ADD CONSTRAINT `tbl_invoice_ibfk_2` FOREIGN KEY (`orderID`) REFERENCES `tbl_order` (`orderID`);
...
--
ALTER TABLE `tbl_product`
  ADD CONSTRAINT `restaurantID` FOREIGN KEY (`restaurantID`) REFERENCES `tbl_restaurant` (`restaurantID`);

--
-- Constraints for table `tbl_restaurant`
--
ALTER TABLE `tbl_restaurant`
  ADD CONSTRAINT `locationID` FOREIGN KEY (`locationID`) REFERENCES `tbl_location` (`locationID`);
