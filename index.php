<?php
	session_start();
  require_once("USER_MODULE/PHP/phpMethods.php");
	$varPopup = 1;
	$varStyleSheet = "USER_MODULE/CSS/indexCSS.css";

	if($varPopup == 1){
		$varStyleSheet = "USER_MODULE/CSS/indexCSS.css";
	} elseif($varPopup == 2){
		$varStyleSheet = "USER_MODULE/CSS/login.css";
	}
...
<head>
  ...
  <link href="USER_MODULE/CSS/popupStyles.css" rel="stylesheet">
  <script defer src="USER_MODULE/js/popupScript.js"></script>
	...
	<nav class= "navbar navbar-expand-md navbar-light bg-light sticky-top">
		<div class="container">
			<a class="navbar-brand" href="javascript:history.go(0)">
				<img src="USER_MODULE/imageshome/logogreen.png" alt="Green soko">
			</a>
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item">
						<a class="nav-link" href="USER_MODULE/FRONT/contacts.php">Contact us</a>
					</li>
					<?php displayCart(); ?>
					<li class="nav-item">
						<a class="nav-link" href="<?php dashRedirectPage(); ?>"><?php dashRedirectDisplay(); ?></a>
					</li>
				</ul>
			</div>
		</div>
	...
	<div id="slides" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner">
			<div class="carousel-item active">
				<img class="d-block w-100" src="USER_MODULE/imageshome/background1.jpg" alt="first slide">
			...
			<div class="carousel-item">
				<img class="d-block w-100" src="USER_MODULE/imageshome/background2.jpg" alt="second slide">
			</div>
			<div class="carousel-item">
				<img class="d-block w-100" src="USER_MODULE/imageshome/background3.jpg" alt="third slide">
			</div>
		</div>
	</div>
<!--- End Image Slider -->
			...
			<div class="row text-center padding">
					...
					<div class="storeInfo__wrapper">
						<div class="storeInfo__item">
							<div class="storeInfo__icon">
								<img src="USER_MODULE/imageshome/fast.png" alt="">
							</div>
				...
				<div class="col-xs-12 col-sm-6 col-md-4">
					<div class="storeInfo__wrapper">
						<div class="storeInfo__item">
							<div class="storeInfo__icon">
								<img src="USER_MODULE/imageshome/delivery.png" alt="">
							</div>
				...
				<div class="col-xs-12 col-sm-6 col-md-4">
					<div class="storeInfo__wrapper">
						<div class="storeInfo__item">
							<div class="storeInfo__icon">
								<img src="USER_MODULE/imageshome/food.png" alt="">
							</div>
	...
	<div class="container-fluid padding gray">
		<div class="container" id="hero">
			<div class="row padding">
				...
				<div class="col-lg-6">
					<img src="USER_MODULE/imageshome/user1.png" class="image-fluid" width="90%" height="auto"  alt="">
				</div>
			</div>
		</div>
	</div>
	...
	<div class="container-fluid padding">
		<div class="container">
			<div class="row padding">
				<div class="col-md-4">
					<div class="card">
						<img src="USER_MODULE/imageshome/image1.png" alt="" class="card-img-top">
						<div class="card-body">
				...
				<div class="col-md-4">
					<div class="card">
						<img src="USER_MODULE/imageshome/image2.png" alt="" class="card-img-top">
						<div class="card-body">
				...
				<div class="col-md-4">
					<div class="card">
						<img src="USER_MODULE/imageshome/image5.png" alt="" class="card-img-top">
						<div class="card-body">
	...
	<div class="container" id="hero">
		<div class="row padding">
			<div class="col-md-12 col-lg-6">
				<img src="USER_MODULE/imageshome/happy.jpg" class="image-fluid" width="90%" height="auto" alt="customer">
			</div>
...
<div class="col-12">
	<center>
	<h6><img src="USER_MODULE/imageshome/logogreen.png" width="6%" alt=""> &copy; greensoko </h6>
	</center>
</div>
</body>
</html>
