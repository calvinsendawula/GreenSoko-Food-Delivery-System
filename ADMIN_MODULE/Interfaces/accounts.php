...
<br>
<h3 style="text-align:center;">Users |
    <a id="admin" href="displayAdmin.php" style="text-align:center; color:#8AC800; text-decoration:none;">Admins</a>
</h3>
<br>
<?php
...
$sql = "SELECT * FROM tbl_user LIMIT ". $this_page_first_result. ",". $results_per_page;
...
for ($page=1; $page<=$number_of_pages ; $page++) {
    echo "<a id='link' style=' color:black;text-decoration:none;' href='accounts.php?page=" . $page ."'>" . $page . " </a> ";
}
