...
$sql = "SELECT * FROM tbl_restaurant LIMIT ". $this_page_first_result. ",". $results_per_page;
...
<table>
  ...
  while($row = mysqli_fetch_assoc($result)) {
    ...
    echo "<td>" . $row['restaurantName'] . "</td>";
     ...
     <td> <img class="images" src="<?php echo "../images/".$row['restaurantImage']; ?>" alt="Image" ></td>

      <td>
      <a href="editRestaurant.php?id=<?php echo $row['restaurantID']; ?>  " name="username" class='button-2'>EDIT</a>
      <a href="../Controller/delete.php?restaurantID=<?php echo $row['restaurantID']; ?>" name="deletion" class="button-2">DELETE</a>
      </td>
          <?php
    echo "</tr>";
}
...
for ($page=1; $page<=$number_of_pages ; $page++) {
    echo "<a id='link' style=' color:black;text-decoration:none;' href='restaurant.php?page=" . $page ."'>" . $page . " </a> ";
