...
<br>
<h3 style="text-align:center;">Food Items</h3>
<br>
<?php
...
<table>
  ...
  while($row = mysqli_fetch_assoc($result)) {
      ...
      echo "<td style='word-wrap: break-word;'>" . $row['productName'] . "</td>";
      ?>
      <td>
          <img class="images" src="<?php echo "../images/".$row['productImage']; ?>" alt="Image" >
      </td>
      <?php
      ...
      echo"<td>";
      ?>
    <a style="text-decoration:none;" href="editFood.php?id=<?php echo $row['productID']; ?>  " name="edit" class="button-2">EDIT</a>
    <a href="../Controller/delete.php?productID=<?php echo $row['productID']; ?>" name="deletion" class="button-2">DELETE</a>
    <?php
    echo "</td>";
    echo "</tr>";
...
for ($page=1; $page<=$number_of_pages ; $page++) {
    echo "<a id='link' style=' color:black;text-decoration:none;' href='fooditems.php?page=" . $page ."'>" . $page . " </a> ";
}
