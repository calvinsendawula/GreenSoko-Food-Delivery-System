...
?>
    ...
    <br>
    <h3 style="text-align:center;">User Order |
        <a id="admin" href="userOrderItems.php" style="text-align:center; color:#8AC800; text-decoration:none;">User Order Items</a>
    </h3>
    <br> <br>
    <?php
    ...
    $sql = "SELECT * FROM tbl_user_order LIMIT ". $this_page_first_result. ",". $results_per_page;
