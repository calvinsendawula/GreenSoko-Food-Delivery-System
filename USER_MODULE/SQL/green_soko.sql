...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 20, 2022 at 07:37 AM
...
(69062182, 84575464, '0', 'john@example.com', '1', '../imagesDashboard/user_default.png', NULL, '2022-06-12 09:49:57', '2022-06-12 09:49:57', '0'),
...
--
ALTER TABLE `tbl_user_order`
  MODIFY `userOrderID` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15146210;

--
-- AUTO_INCREMENT for table `tbl_user_order_item`
--
ALTER TABLE `tbl_user_order_item`
  MODIFY `userOrderItemID` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27116137;
