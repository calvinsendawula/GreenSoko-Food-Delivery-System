  ...
  <body>
    <div id="dashboard-form-shell">
      <div class="card container" id="dashboard-form">
        <div class="card-body">
          <form method="post" action="../DASHBOARDPHP/processOTP.php" enctype="multipart/form-data">
            <div class="row">
              <div class="col">
                <div class="form-group">
                  <div class="row text-center">
  								...
  								<div class="row text-center">
  									<div class="col">
  										<h5 class="font-weight-bold">Password reset in progress</h5>
  									</div>
  								</div>
  								<div class="row text-center">
  									<div class="col">
                      ...
                      <p>To proceed to reset your password, enter the One-Time-Pin sent to you via your registered email.</p>
  									</div>
  								</div>
                  <div class="row text-center">
                    <div class="col-2"></div>
                    <div class="col-8">
                      <div class="form-group">
                        <label class="font-weight-bold" for="otp">Enter OTP</label><br>
      									<input type="number" class="form-control text-center" maxlength="6" autocomplete="off" name="otp" required placeholder="_ _ _ _ _ _">
                      </div>
                    </div>
                  </div><br>
                </div>
            ...
            <div class="text-center">
              ...
              <button class="btn btn-outline-dark text-center" type="submit" role="button" name="checkOTP" id="saveChangesBtn">Check OTP</button>
            </div>
          </form>
        </div>
      </div>
