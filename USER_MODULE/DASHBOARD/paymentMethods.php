<?php
  ...
  require_once("../PHP/phpMethods.php");
	...
	$result = getData($sql);
		if(!empty($result)){
			$varCardHolder = "value='".$result["cardHolder"]."'";
      $varCCN = "value='".$result["CCN"]."'";
      $varValidity = "value='".$result["validity"]."'";
      $varCVV = "value='".$result["CVV"]."'";
		} else{
			$varCardHolder = "placeholder='Jane Doe'";
      $varCCN = "placeholder='4000 1234 5678 9010'";
      $varValidity = "placeholder='12/20'";
      $varCVV = "placeholder='208'";
		}
...
<head>
  ...
  <link rel="stylesheet" href="../DASHBOARDCSS/paymentCSS.css">
...
<body>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-8">
          ...
          <form action="../DASHBOARDPHP/processCardDetails.php" method="post" autocomplete="off">
            <div class="card" id="dashboard-form">
              <div class="card-body">
                <div class="row">
                  <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 text-center" id="visa-card">
                    <div class="visa-card"></div>
                  </div>
                  <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <h4 class="font-weight-bold text-center">Debit/Credit Card Details</h4>
                    <div class="card">
                      <div class="card-body">
                        <div class="row">
                          <div class="col-12">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" autocomplete="off" name="cardHolder" <?php echo $varCardHolder; ?> required>
                            </div>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-12">
                            <div class="form-group">
                              ...
                              <input type="text" inputmode="numeric" class="form-control" autocomplete="off" name="ccn" data-mask="____ ____ ____ ____" <?php echo $varCCN; ?> required>
                            </div>
                          </div>
                        </div>
                        <div class="row text-center">
                          <div class="col-xl-5 col-lg-5 col-md-5 col-sm-4 col-xs-4"><!-- col-4 -->
                            <div class="form-group">
                              <label for="validity">Validity</label><br>
            									<input type="text" class="form-control text-center" autocomplete="off" name="validity" data-mask="__/__" <?php echo $varValidity; ?> required>
                            </div>
                          </div>
                          <div class="col-xl-5 col-lg-5 col-md-5 col-sm-3 col-xs-3"><!-- col-3 -->
                            <div class="form-group">
                              <label for="CVV">CVV</label><br>
            									<input type="text" inputmode="numeric" class="form-control text-center" autocomplete="off" name="CVV" data-mask="___" <?php echo $varCVV; ?> required>
                            </div>
                          </div>
                          <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-xs-2"><!-- col-1 -->
                            <div class="form-group">
                              <a id="cvv" href="https://bit.ly/3NKfUuu" target="_blank" class="btn btn-outline-info material-symbols-rounded"><text>help</text></a>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <br>
								...
								<div class="row" id="submit-buttons">
									...
									<div class="col-4"></div>
									<div class="col-6">
										<a class="btn btn-outline-dark text-center" id="discardChangesBtn" onClick="window.location.href='../DASHBOARD/paymentMethods.php'">Discard changes</a>
  ...
  <script src="../js/maskJS.js"></script>
</body>
